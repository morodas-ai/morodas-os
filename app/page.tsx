...
export default function HomePage() {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center animate-in">
      {/* ロゴ */}
      <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-emerald-400 to-emerald-600 flex-center shadow-xl mb-8">
        <span className="font-bold text-white text-4xl">M</span>
      </div>

      {/* タイトル */}
      <h1 className="text-4xl font-bold text-slate-900 mb-3">
        MORODAS <span className="text-emerald-600">OS</span>
      </h1>
